...
describe Sboot::Editor do
  ...
  describe 'should publish the stack' do
    ...
    it 'should publish backend' do
      domain_entity_backend = DomainEntity.new name: 'Casa', name_pluralized: 'Case', properties: [{name: 'indirizzo',type: 'String'},{name: 'civico',type: 'Long'}], environment: 'backend'
    ...
    it 'should publish business' do
      domain_entity_business = DomainEntity.new name: 'Casa', name_pluralized: 'Case', properties: [{name: 'indirizzo',type: 'String'},{name: 'civico',type: 'Long'}], environment: 'business'
    ...
    it 'should publish conversion' do
      domain_entity_conversion = DomainEntity.new name: 'Casa', name_pluralized: 'Case', properties: [{name: 'indirizzo',type: 'String'},{name: 'civico',type: 'Long'}], environment: 'conversion'
    ...
    it 'should publish persistence' do
      domain_entity_persistence = DomainEntity.new name: 'Casa', name_pluralized: 'Case', properties: [{name: 'indirizzo',type: 'String'},{name: 'civico',type: 'Long'}], environment: 'persistence'
