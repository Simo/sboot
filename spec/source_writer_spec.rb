...
describe Sboot::SourceWriter do
  ...
  subject(:writer){ Sboot::SourceWriter.new }
  ...
  describe 'initialization' do
    ...
    it 'should be correctly initialized by a writer' do
      expect(writer.respond_to? 'write_file').to be true
    end

    it 'should have property src_path' do
      expect(writer.instance_variable_get(:@src_path)).to eql '.'
    end
