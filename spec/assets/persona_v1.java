...
public class PersonaControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        persona1.setCasaId(new Integer(10));
    ...
    public void salvaPost() throws Exception {
        ...
        personaNew.setCasaId(new Integer(10));
        ...
        personaNew2.setCasaId(new Integer(10));
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.post("/persone")
                ...
                .param("casa_id",personaNew.getCasaId().toString())
    ...
    public void salvaPut() throws Exception {
        ...
        personaUpdate.setCasaId(new Integer(10));
        ...
        this.mockMvc.perform(MockMvcRequestBuilders.put("/persone/"+personaUpdate.getPersonaId())
                ...
                .param("casa_id",personaUpdate.getCasaId().toString())
    ...
    public void deleteRest() throws Exception {
        ...
        personaDelete.setCasaId(new Integer(10));
