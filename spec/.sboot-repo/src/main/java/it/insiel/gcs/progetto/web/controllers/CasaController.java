...
public class CasaController {
    ...
    public ModelAndView dettaglio(@PathVariable Long id){
        ModelAndView mav = new ModelAndView("casa/show");
    ...
    public ModelAndView nuovo(){
        ModelAndView mav = new ModelAndView("casa/new");
    ...
    public ModelAndView modifica(@PathVariable Long id){
        ModelAndView mav = new ModelAndView("casa/edit");
				mav.addObject("casa",service.trova(id));
				return mav;
    }
    ...
    public String deleteRest(@PathVariable Long id){
				Long numberOfDeletions = service.cancella(id);
				return "redirect:/case";
    }

		@RequestMapping(value = "/case/{id}/delete",method = RequestMethod.GET)
