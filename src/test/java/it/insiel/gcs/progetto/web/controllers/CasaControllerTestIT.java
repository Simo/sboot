...
public class CasaControllerTest {
    ...
    public void salvaPost() throws Exception {
        ...
        CasaDTO casaNew = new CasaDTO();
                casaNew.setId(1L);
                casaNew.setIndirizzo civico(1L);
                CasaDTO casaNew2 = new CasaDTO();
        casaNew2.setId(2L);
                casaNew2.setId(1L);
                casaNew2.setIndirizzo civico(1L);
    ...
    public void salvaPut() throws Exception {
        ...
        casaUpdate.setId(1L);
                casaUpdate.setId(1L);
                casaUpdate.setIndirizzo civico(1L);
    ...
    public void deleteRest() throws Exception {
        ...
        casaDelete.setId(1L);
                casaDelete.setId(1L);
                casaDelete.setIndirizzo civico(1L);
